...
with SB (
    ...
    all_bids = tree.xpath("//div[@class='vc_row wpb_row vc_row-fluid']//p[position()>1][.//a][not(contains(normalize-space(.), 'Notice of Cancellation'))]")
    ...
    for node_idx, node in enumerate(all_bids,start=1):
        ...
        for file_idx, file in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://crdact.net/",file_url)

...
with SB (
    ...
    for node_idx, node in enumerate(project_nodes,start=1):
        ...
        if bid_due_date.lower() == "open until contracted":
        ...
        directed_links = node.xpath("./td[1]/a[@href]")
        ...
        for directed_link in directed_links:
            ...
            directed_url = urljoin("https://www.olympiawa.gov/",directed_url)
            ...
            save_nodes_as_pdf(
                        ...
                        base_url="https://www.olympiawa.gov/",
            )
            ...
            file_links = tree.xpath("//main[@id='freeform-main']/div[@id='post']//ul//a")
            ...
            for file_idx, file_link in enumerate(file_links, start = 1):
                ...
                file_url = urljoin("https://www.olympiawa.gov/",file_url)

...
with SB (
    ...
    bid_nodes = tree.xpath("//div[@class='filters1_feed']/div[2]//div[@role='listitem' and contains(normalize-space(),'Aug 18, 2026')]/preceding-sibling::div")
    print(len(bid_nodes))
    ...
    for node_idx, node in enumerate(bid_nodes,start=1): 
        bid_title = node.xpath("./div/div[2]")[0].text_content().strip()

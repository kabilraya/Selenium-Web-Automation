...
with SB (
    ...
    for node_idx, node in enumerate(bid_nodes,start=1): 
        ...
        m = re.search(number_pattern, bid_title)
        ...
        if formatted_date:
            try:
                ...
                try:
                    ...
                    print("Couldn't parse the date.. Skipping")
                    continue
        ...
        directed_link = urljoin("https://www.catoosacountyga.gov/",directed_link)
        ...
        for file_idx, file_link in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://www.catoosacountyga.gov/",file_url)

...
with SB (
    ...
    all_bids = tree.xpath("//div[contains(@class,'page-block-text')][contains(normalize-space(.),'2025-2026')]/preceding-sibling::div[./ul]/ul/li")
    ...
    for node_idx, node in enumerate(all_bids,start=1):
        ...
        for file_idx, file in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://www.whsd.net/",file_url)

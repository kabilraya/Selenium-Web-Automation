...
with SB (
    ...
    bid_nodes = tree.xpath("//tr[contains(normalize-space(),'08/18/2026 2:00 PM')]/preceding-sibling::tr")
    print(len(bid_nodes))
    ...
    for node_idx, node in enumerate(bid_nodes,start=1): 
        ...
        directed_link = urljoin("https://www.cityofmerced.gov/",directed_link)
        ...
        for file_idx, file_link in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://www.cityofmerced.gov/",file_url)

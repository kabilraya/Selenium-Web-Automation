...
with SB (
    ...
    project_nodes = tree.xpath("//div[@aria-label='RFP Posts List']/table/tbody/tr")
    ...
    for node_idx, node in enumerate(project_nodes,start=1):
        ...
        if not directed_link:
            continue
        directed_link = urljoin("https://www.cityofdelrio.com/",directed_link)
        ...
        info_table = "//h2[@class='detail-title'] | // ul[@class='detail-list'] | //div[@class='detail-content']"
        ...
        if is_duplicate_hash:
            ...
            save_nodes_as_pdf(
                        ...
                        base_url="https://www.cityofdelrio.com/",
            )
        ...
        for file_idx, file_link in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://www.cityofdelrio.com/",file_url)

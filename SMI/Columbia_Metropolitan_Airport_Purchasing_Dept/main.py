...
with SB (
    ...
    bid_nodes = tree.xpath("//li[contains(normalize-space(),'RFP for Solar PV System Repairs, Operations & Maintenance')]/preceding-sibling::li")
    ...
    for node_idx, node in enumerate(bid_nodes,start=1): 
        ...
        for file_idx, file in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://flycae.com/",file_url)

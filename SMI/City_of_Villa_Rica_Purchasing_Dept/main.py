...
with SB (
    ...
    bid_nodes = tree.xpath("//div[@id='post']/div/table//table/tbody/tr[.//a]")
    ...
    for node_idx, node in enumerate(bid_nodes,start=1): 
        ...
        directed_url = urljoin("https://www.villarica.org/",directed_url)
        ...
        info_table = "//main[@id='freeform-main']"
        ...
        save_nodes_as_pdf(
                    ...
                    base_url="https://www.villarica.org/",
        )
        ...
        file_links = tree.xpath("//main[@id='freeform-main']//a")
        if not file_links:
            continue
        ...
        for file_idx, file in enumerate(file_links, start = 1):
            ...
            file_url = urljoin("https://www.villarica.org/",file_url)

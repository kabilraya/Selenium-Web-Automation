...
with SB (
    ...
    for node_idx, node in enumerate(project_nodes,start=1):
        bid_title = node.xpath("./div[@class='bidTitle']/span[1]")[0].text_content().strip()
        bid_no = node.xpath("./div[@class='bidTitle']/span[2]/text()[normalize-space()]")[0].strip()
        bid_due_date = node.xpath("./div[@class='bidStatus']/div[2]/span[2]")[0].text_content().strip()
        ...
        directed_links = node.xpath("./div[@class='bidTitle']/span[1]/a")
        ...
        for idx, directed_link in enumerate(directed_links):
            ...
            directed_url = urljoin("https://www.huttotx.gov/",directed_url)
            ...
            file_links = tree.xpath("//div[@class='relatedDocuments']/a")
            ...
            for file_idx, file_url in enumerate(file_links, start = 1):
                ...
                url = urljoin("https://www.huttotx.gov/",url)
